<?php
// src/translations/de/blocksmith.php

return [
    "Please select a volume for preview images." =>
        "Bitte wähle ein Volume für Vorschau-Bilder aus.",
    "The subfolder must be a valid string." =>
        "Der Unterordner muss ein gültiger String sein.",
    "No volumes found for the plugin settings." =>
        "Keine Volumes für die Plugin-Einstellungen gefunden.",
    "No volumes are available." => "Keine Volumes verfügbar.",
    "Search" => "Suche",
    ...
    "A default volume has been set automatically. You can update it here if necessary." =>
        "Ein Standard-Volume wurde automatisch gesetzt. Du kannst es hier anpassen.",
    "No volume has been set. Please select a volume to store preview images." =>
        "Kein Volume wurde gesetzt. Bitte wähle ein Volume für Vorschau-Bilder aus.",
    "Preview Image Volume" => "Vorschau-Volume",
    "Choose the volume where preview images will be stored." =>
        "Wähle das Volume, in dem Vorschau-Bilder gespeichert werden.",
    "Subfolder (optional)" => "Unterordner (optional)",
    ...
    'Enable support for Matrix fields using the “As cards” view mode. This allows adding new cards via the "New entry" button and inserting cards above existing ones through the enhanced context menu.' =>
        "Aktiviere die Unterstützung für Matrix-Felder im Ansichtsmodus „Als Karten“. Dadurch können neue Karten über die Schaltfläche „Neuer Eintrag“ hinzugefügt und Karten über das erweiterte Kontextmenü oberhalb bestehender eingefügt werden.",

    'Cards support is disabled – these settings have no effect on fields using the "As cards" view mode.' =>
        "Kartenunterstützung ist deaktiviert – diese Einstellungen haben keine Auswirkungen auf Felder im Ansichtsmodus „Als Karten“.",

    "Enable Blocksmith" => "Blocksmith aktivieren",

    "Enable Cards support" => "Kartenunterstützung aktivieren",
    ...
    "Configure Categories" => "Kategorien konfigurieren",
    "Note: " => "Hinweis: ",
    "UI Mode" => "UI-Modus",
    ...
    "Categories are only used in the <strong>Preview Modal</strong> and do not affect how Button Groups are displayed." =>
        "Kategorien werden nur im <strong>Vorschau-Modal</strong> verwendet und beeinflussen nicht die Anzeige der Button-Gruppen.",
    "These settings apply to the <strong>Preview Modal</strong> and have no effect on the appearance of Button Groups." =>
        "Diese Einstellungen gelten für das <strong>Vorschau-Modal</strong> und haben keinen Einfluss auf das Erscheinungsbild der Button-Gruppen.",
    "The following options apply to the <strong>Preview Modal</strong> UI mode, which is only available in the <strong>Pro Edition</strong>." =>
        "Die folgenden Optionen gelten für den UI-Modus <strong>Vorschau-Modal</strong>, der nur in der <strong>Pro-Version</strong> verfügbar ist.",
    "UI Mode is fixed to Button Group in the Lite Edition. Upgrade to <strong>Pro</strong> to use the <strong>Preview Modal</strong>." =>
        "Der UI-Modus ist in der Lite-Version auf Button-Gruppe festgelegt. Upgrade auf <strong>Pro</strong>, um das <strong>Vorschau-Modal</strong> zu verwenden.",
    "These settings apply to the <strong>Preview Modal</strong> UI Mode, which is only available in the <strong>Pro Edition</strong>." =>
        "Diese Einstellungen gelten für den UI-Modus <strong>Vorschau-Modal</strong>, der nur in der <strong>Pro-Version</strong> verfügbar ist.",

    "Organize Button Group entries using Craft’s native Entry Type Groups" =>
        "Organisiere Button Group-Einträge anhand der nativen Entry Type Groups von Craft",
    "Enable this option to group buttons in Blocksmith’s Button Groups based on the Entry Type Groups (if defined) in Craft’s Matrix Field settings." =>
        "Aktiviere diese Option, um Buttons in den Blocksmith Button Groups gemäß den (falls definiert) Entry Type Groups in den Matrix-Feld-Einstellungen von Craft zu gruppieren.",
    "This feature requires Craft CMS 5.8 or newer." =>
        "Diese Funktion erfordert Craft CMS 5.8 oder neuer.",
];
