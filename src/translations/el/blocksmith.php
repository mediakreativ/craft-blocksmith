...
return [
    ...
    "Enable this option to use automatic image assignment based on entry type handles. The preview images need to be named after their block handle (e.g., textAndImage.png)." =>
        "Ενεργοποιήστε αυτή την επιλογή για να χρησιμοποιήσετε αυτόματη αντιστοίχιση εικόνων βάσει των handles των τύπων εγγραφών. Οι εικόνες προεπισκόπησης πρέπει να ονομάζονται σύμφωνα με το handle του μπλοκ (π.χ. textAndImage.png).",
